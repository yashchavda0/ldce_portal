...
const GetAllCertificateType = [

    async (req, res) => {
    
        try {

            const getAllCertificateType = await StudentQueries.getAllCertificateType()
         ...
         * /*/
            ...
            if (getAllCertificateType) { 
                return ResponseCodes.successResponseWithData(res, "Success", getAllCertificateType);
            }
            else {
...
module.exports = GetAllCertificateType;